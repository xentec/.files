...
-----------------------------------------------------
vbar.wibox[mainscreen] = awful.wibox({ position = "right", screen = mainscreen })
...
--vbar.wibox[mainscreen]:set_widget(v_layout)
vbar.wibox[mainscreen]:set_widget(wibox.layout.margin(v_layout,2,2,2,2))
-----------------------------------------------------
-- ########################################
-- ## Futher screens
-- ########################################
